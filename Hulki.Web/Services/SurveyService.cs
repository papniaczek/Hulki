...
namespace Hulki.Web.Services
{
    ...
    public class SurveyService : ISurveyService
    {
        ...
        public async Task SubmitSurveyAsync(Guid surveyId, string userId, Dictionary<Guid, string> answers)
        {
        ...
        {
            return await _context.SurveySubmissions.AnyAsync(s => s.SurveyId == surveyId && s.AppUserId == userId);
        }
    }
}